export const pressData: PressDataType[] = [
  ...
  },
  {
    ...
    description:
      '국내 숏폼 콘텐츠 업체 워프코퍼레이션은 협업하는 글로벌 크리에이터들과 함께 모여 숏폼 콘텐츠 협업 작업을 진행했다고 20일 밝혔다. 일본 인기 스포츠 크리에이터 레가테 타쿠야와 레가테 코헤이는 지난 16일부터 3박 4일 일정으로 한국을 방문해서 더투탑, 박한별초롱, 티아고킴 등과 함께 숏폼을 촬영했다.',
    date: '2023-06-20',
  },
  {
